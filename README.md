...
More details on the ideas underlying the techniques used here can also be found in [this paper draft](https://will62794.github.io/assets/papers/interpretable-verification-2024.pdf).
