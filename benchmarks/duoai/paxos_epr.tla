...
TypeOK ==
    /\ one_a \in SUBSET Round
    /\ one_b_max_vote \in SUBSET (Node \X Round \X Round \X Value)
    /\ one_b \in SUBSET (Node \X Round)
    /\ left_rnd \in SUBSET (Node \X Round)
    /\ proposal \in SUBSET (Round \X Value)
    /\ vote \in SUBSET (Node \X Round \X Value)
    /\ decision \in SUBSET (Node \X Round \X Value)
