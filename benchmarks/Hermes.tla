...
HInv16269_aa90_R0_0_I2 == \A VARI \in H_NODES : \A VARJ \in H_NODES : (nodeTS[VARI] = nodeTS[VARJ]) \/ (~(greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)) \/ (~(nodeTS[VARI].tieBreaker = VARJ)))
HInv2349_4d16_R0_0_I2 == \A VARI \in H_NODES : \A VARMVALI \in msgsVAL : ~(VARI \in aliveNodes) \/ (~(greaterTS(VARMVALI.version, VARMVALI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)))
HInv2065_94b3_R0_0_I2 == \A VARI \in H_NODES : \A VARJ \in H_NODES : (greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)) \/ (~(VARI \in aliveNodes)) \/ (~(nodeState[VARJ] = "valid"))
HInv2586_f463_R0_1_I2 == \A VARI \in H_NODES : \A VARJ \in H_NODES : (greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)) \/ (~(VARI \in nodeRcvedAcks[VARJ])) \/ (~(nodeState[VARJ] \in {"write", "replay"}))
HInv3257_59f9_R1_0_I1 == \A VARI \in H_NODES : \A VARMINVI \in msgsINV : ~(VARMINVI.tieBreaker = VARI) \/ (~(greaterTS(VARMINVI.version, VARMINVI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)))
HInv2796_9992_R4_0_I1 == \A VARI \in H_NODES : (nodeTS[VARI] = nodeLastWriteTS[VARI]) \/ (~(nodeState[VARI] \in {"write", "replay"}))
HInv3739_c35e_R4_0_I1 == \A VARI \in H_NODES : \A VARMACKI \in msgsACK : ~(VARMACKI.sender = VARI) \/ (~(greaterTS(VARMACKI.version, VARMACKI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)))
...
\* Inv560_R0_1_I2 == \A VARI \in aliveNodes : \A VARJ \in aliveNodes : ~(nodeTS[VARI].tieBreaker = VARJ) \/ (~(nodeTS[VARI].version > nodeTS[VARJ].version))
\* Inv22391_R0_1_I2 == \A VARI \in aliveNodes : \A VARJ \in aliveNodes : (nodeTS[VARI].version >= nodeTS[VARJ].version) \/ (~(VARI \in nodeRcvedAcks[VARJ])) \/ (~(nodeState[VARJ] \in {"write", "replay"}))
\* Inv281_R0_1_I2 == \A VARI \in aliveNodes : (nodeTS[VARI].tieBreaker = VARI) \/ (~(nodeState[VARI] = "write"))
\* Inv2976_R0_1_I2 == \A VARI \in aliveNodes : \A VARJ \in aliveNodes : (greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)) \/ (~(VARI \in nodeRcvedAcks[VARJ])) \/ (~(nodeState[VARJ] = "replay"))
\* Inv23347_R0_1_I2 == \A VARI \in aliveNodes : \A VARJ \in aliveNodes : ~(VARI \in nodeRcvedAcks[VARJ]) \/ (~(nodeState[VARI] = "valid")) \/ (~(nodeState[VARJ] = "write"))
\* Inv472_R0_1_I2 == \A VARI \in aliveNodes : ~(nodeState[VARI] = "invalid") \/ (~(nodeTS[VARI].tieBreaker = VARI))
\* Inv481_R0_1_I2 == \A VARI \in aliveNodes : ~(nodeState[VARI] = "invalid_write") \/ (~(nodeTS[VARI].tieBreaker = VARI))
\* Inv4747_R1_0_I2 == \A VARI \in aliveNodes : \A VARJ \in aliveNodes : (greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)) \/ (~(VARI \in nodeRcvedAcks[VARJ]) \/ (~(nodeState[VARJ] = "write")))
\* Inv117_R1_0_I2 == \A VARI \in aliveNodes : \A VARMVALI \in msgsVAL : ~(equalTS(VARMVALI.version, VARMVALI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)) \/ (~(nodeState[VARI] = "write"))
\* Inv19_R3_0_I3 == \A VARMINVI \in msgsINV : ~(VARMINVI.epochID > epochID)
\* Inv1885_R3_0_I3 == \A VARI \in aliveNodes : \A VARMINVI \in msgsINV : ~(VARMINVI.sender = VARI) \/ (~(greaterTS(VARMINVI.version, VARMINVI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)))
\* Inv386_R3_0_I3 == \A VARMINVI \in msgsINV : (VARMINVI.sender \in aliveNodes) \/ (~(VARMINVI.epochID = epochID))
\* Inv6274_R3_0_I3 == \A VARI \in aliveNodes : \A VARJ \in aliveNodes : \A VARMINVI \in msgsINV : (VARMINVI.version < nodeTS[VARJ].version) \/ ((VARMINVI.version = nodeTS[VARJ].version)) \/ (~(VARMINVI.version < nodeTS[VARI].version))
\* Inv10253_R3_0_I3 == \A VARI \in aliveNodes : \A VARJ \in aliveNodes : (nodeTS[VARI] = nodeTS[VARJ]) \/ (~(nodeState[VARI] = "replay")) \/ (~(nodeTS[VARI].tieBreaker = VARJ))
\* Inv1896_R3_0_I3 == \A VARI \in aliveNodes : \A VARMINVI \in msgsINV : (VARMINVI.sender = VARI) \/ (~(VARMINVI.tieBreaker = nodeTS[VARI].tieBreaker) \/ (~(nodeTS[VARI].tieBreaker = VARI)))
\* Inv12279_R3_0_I3 == \A VARI \in aliveNodes : \A VARJ \in aliveNodes : \A VARMINVI \in msgsINV : ~(VARMINVI.sender = VARJ) \/ (~(nodeState[VARJ] \in {"write", "valid"})) \/ (~(VARMINVI.tieBreaker < nodeTS[VARJ].tieBreaker)) \/ (~(greaterTS(VARMINVI.version, VARMINVI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)))
\* Inv2451_R3_0_I3 == \A VARI \in aliveNodes : \A VARMINVI \in msgsINV : (VARMINVI.tieBreaker = nodeTS[VARI].tieBreaker) \/ (~(nodeTS[VARI].tieBreaker = VARI)) \/ (~(VARMINVI.sender = VARI)) \/ ((nodeState[VARI] \in {"write", "valid"}))
\* Inv33_R4_0_I2 == \A VARMACKI \in msgsACK : ~(VARMACKI.epochID > epochID)
\* Inv2578_R4_0_I2 == \A VARI \in aliveNodes : (nodeTS[VARI] = nodeLastWriteTS[VARI]) \/ (~(nodeState[VARI] \in {"write", "replay"}))
\* Inv10043_R4_0_I2 == \A VARI \in aliveNodes : \A VARMACKI \in msgsACK : (nodeState[VARI] \in {"write", "replay"}) \/ (~(greaterTS(VARMACKI.version, VARMACKI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker))) \/ (~(VARMACKI.sender = VARI))
L_Inv560_R0_1_I2 == \A VARI \in aliveNodes : \A VARJ \in aliveNodes : ~(nodeTS[VARI].tieBreaker = VARJ) \/ (~(nodeTS[VARI].version > nodeTS[VARJ].version))


H_Inv472_R0_1_I2 == \A VARI \in aliveNodes : ~(nodeState[VARI] = "invalid") \/ (~(nodeTS[VARI].tieBreaker = VARI))
H_Inv4778_R0_0_I2 == \A VARI \in H_NODES : (nodeState[VARI] = "invalid_write") => (nodeTS[VARI].tieBreaker # VARI)

LL1 == \A m \in msgsINV, n \in aliveNodes : 
        (greaterTS(m.version, m.tieBreaker, nodeTS[n].version, nodeTS[n].tieBreaker) 
         /\ m.sender # n /\ nodeState[n] \notin {"valid", "invalid", "replay"}) => m.tieBreaker # n

\* Inv54 == \A VARMINVI \in msgsINV : ~(VARMINVI.epochID > epochID)
\* Inv532 == \A VARMINVI \in msgsINV : (VARMINVI.sender \in aliveNodes) \/ (~(VARMINVI.epochID = epochID))
\* Inv4857 == \A VARI \in H_NODES : \A VARJ \in aliveNodes : ~(nodeState[VARI] = "valid") \/ (~(nodeTS[VARI].version > nodeTS[VARJ].version))
\* Inv5652 == \A VARI \in H_NODES : \A VARJ \in aliveNodes : \A VARMINVI \in msgsINV : (VARMINVI.version < nodeTS[VARJ].version) \/ ((VARMINVI.version = nodeTS[VARJ].version)) \/ (~(VARMINVI.version < nodeTS[VARI].version))
\* Inv3493 == \A VARI \in H_NODES : (nodeTS[VARI].tieBreaker = VARI) \/ (~(nodeState[VARI] = "write"))
\* Inv12021 == \A VARI \in H_NODES : \A VARJ \in aliveNodes : ~(nodeState[VARI] \in {"write", "replay"}) \/ (~(nodeTS[VARI].tieBreaker < nodeTS[VARJ].tieBreaker)) \/ (~(nodeTS[VARI].tieBreaker = VARJ))

H_Inv3097_R0_0_I2 == \A VARI \in H_NODES : \A VARJ \in aliveNodes : ~(nodeTS[VARI].tieBreaker = VARJ) \/ (~(nodeTS[VARI].version > nodeTS[VARJ].version))
H_Inv127_R0_0_I2 == \A VARI \in H_NODES : (VARI \in aliveNodes) \/ (~(nodeState[VARI] = "replay"))


H_Inv332_R0_1_I2 == \A VARI \in H_NODES : \A VARJ \in aliveNodes : (greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)) \/ (~(VARI \in nodeRcvedAcks[VARJ])) \/ (~(nodeState[VARJ] \in {"write", "replay"}))

H_Inv7673_R0_1_I2 == \A VARI \in H_NODES : \A VARJ \in aliveNodes : (nodeState[VARJ] = "replay") \/ (~(nodeState[VARI] = "replay") \/ (~(nodeTS[VARI].tieBreaker = VARJ)))
H_Inv2699_R0_0_I2 == \A VARI \in H_NODES : ~(nodeState[VARI] = "invalid") \/ (~(nodeTS[VARI].tieBreaker = VARI))

\* H1_Inv10 == \A VARI \in H_NODES : \A VARJ \in aliveNodes : ~(nodeTS[VARI].tieBreaker = VARJ) \/ (~(nodeTS[VARI].version > nodeTS[VARJ].version))
H_Inv10_R15_0_I1 == \A VARI \in H_NODES : \A VARMINVI \in msgsINV : ~(VARMINVI.tieBreaker = VARI) \/ (~(greaterTS(VARMINVI.version, VARMINVI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)))


H_Inv9309_R0_0_I2 == \A VARI \in H_NODES : \A VARJ \in H_NODES : (greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)) \/ (~(VARI \in aliveNodes) \/ (~(nodeState[VARJ] = "valid")))


Inv9693_R0_0_I2 == \A VARI \in H_NODES : \A VARMVALI \in msgsVAL : (greaterOrEqualTS(VARMVALI.version, VARMVALI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)) \/ (~(NewestVALMsg(VARMVALI) /\ msgsVAL = msgsVAL) \/ (~(nodeState[VARI] = "valid")))


LInv2351_4d16_R0_0_I2 == \A VARI \in H_NODES : \A VARMVALI \in msgsVAL : ~(VARI \in aliveNodes) \/ (~(greaterTS(VARMVALI.version, VARMVALI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)))
LInv2212_717b_R0_0_I2 == \A VARI \in H_NODES : \A VARJ \in H_NODES : (greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)) \/ (~(VARI \in aliveNodes) \/ (~(nodeState[VARJ] = "valid")))
LInv6891_e7c4_R0_1_I2 == \A VARI \in H_NODES : \A VARJ \in H_NODES : (nodeTS[VARI] = nodeTS[VARJ]) \/ (~(nodeTS[VARI].tieBreaker = VARJ)) \/ (~(greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)))
LInv2219_b12b_R0_1_I2 == \A VARI \in H_NODES : \A VARJ \in H_NODES : (greaterOrEqualTS(nodeTS[VARI].version, nodeTS[VARI].tieBreaker, nodeTS[VARJ].version, nodeTS[VARJ].tieBreaker)) \/ (~(nodeState[VARJ] \in {"write", "replay"})) \/ (~(VARI \in nodeRcvedAcks[VARJ]))
LInv3244_59f9_R3_0_I1 == \A VARI \in H_NODES : \A VARMINVI \in msgsINV : ~(VARMINVI.tieBreaker = VARI) \/ (~(greaterTS(VARMINVI.version, VARMINVI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)))
LInv2783_9992_R4_0_I1 == \A VARI \in H_NODES : (nodeTS[VARI] = nodeLastWriteTS[VARI]) \/ (~(nodeState[VARI] \in {"write", "replay"}))
LInv3730_c35e_R4_0_I1 == \A VARI \in H_NODES : \A VARMACKI \in msgsACK : ~(VARMACKI.sender = VARI) \/ (~(greaterTS(VARMACKI.version, VARMACKI.tieBreaker, nodeTS[VARI].version, nodeTS[VARI].tieBreaker)))
