...
ServerProcessRequestAction == \E n \in Node, r \in Request, i \in DbRequestId : ServerProcessRequest(n,r,i)
DbProcessRequestAction == \E r \in Request, i \in DbRequestId, p \in Response : DbProcessRequest(i,r,p)
ServerProcessDbResponseAction == \E n \in Node, i \in DbRequestId, p \in Response : ServerProcessDbResponse(n,i,p)
ReceiveResponseAction == \E n \in Node, p \in Response : ReceiveResponse(n,p)

Next ==
    \/ NewRequestAction
    \/ ServerProcessRequestAction
    \/ DbProcessRequestAction
    \/ ServerProcessDbResponseAction
