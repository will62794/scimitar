...
LInv29_d5b3_R0_0_I1 == \A VARI \in rAliveNodes : \A VARMVAL \in rMsgsVAL : ~(VARMVAL.type = "VAL" /\ VARMVAL.version > rKeyVersion[VARI])
LInv602_e3dc_R0_0_I1 == \A VARI \in rAliveNodes : \A VARJ \in rAliveNodes : (rKeyVersion[VARI] <= rKeyVersion[VARJ]) \/ (~(rKeyState[VARI] = "valid"))
LInv11144_6aa2_R0_1_I2 == \A VARI \in rAliveNodes : \A VARJ \in rAliveNodes : (rKeyState[VARI] = "invalid") \/ (~(VARI # VARJ /\ VARJ \in rKeyRcvedACKs[VARI])) \/ ((rKeyVersion[VARI] <= rKeyVersion[VARJ]))
LInv795_7788_R3_0_I1 == \A VARJ \in rAliveNodes : \A VARMACK \in rMsgsACK : (VARMACK.version <= rKeyVersion[VARJ]) \/ (~(VARMACK.sender = VARJ))
=============================================================================
